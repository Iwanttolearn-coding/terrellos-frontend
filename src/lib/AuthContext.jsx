...
export const AuthProvider = ({ children }) => {
  ...
  const checkUserAuth = async (signal) => {
    try {
      ...
      // Timeout guard — prevent infinite loading if SDK hangs
      ...
      // Founder override — permanently inject elite/super_admin, never downgrades
      ...
      if (error.message === 'auth_timeout') {
        // Timed out — surface a recoverable error instead of white screen
