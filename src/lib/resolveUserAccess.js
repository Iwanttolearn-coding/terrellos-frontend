...
export function resolveUserAccess(user) {
  ...
  if (isFounder(user.email)) {
    ...
    return {
      ...
      canAccessDeployments: true, canUseVoice: true,
      canUploadFiles: true, canUseAdvancedTools: true,
      allowedRoutes: ['*'],
  ...
  return {
    ...
    canAccessDeployments: isAdmin,
    canUseVoice: isActive || isAdmin,
    canUploadFiles: isActive || isAdmin,
    canUseAdvancedTools: isAdmin,
    allowedRoutes: isAdmin ? ['*'] : ['/', '/tools', '/account', '/billing', '/settings', '/help'],
