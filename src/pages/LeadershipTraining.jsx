...
export default function LeadershipTraining() {
  return (
    <div style={{maxWidth:700,margin:'60px auto',padding:'0 20px',textAlign:'center'}}>
      ...
      <h1 style={{color:'#f9fafb',fontSize:32,fontWeight:800,marginBottom:8}}>Leadership Training</h1>
      <p style={{color:'#6b7280',fontSize:16,lineHeight:1.7,marginBottom:24}}>Pastoral leadership development — vision, administration, counseling, preaching, and church planting.</p>
