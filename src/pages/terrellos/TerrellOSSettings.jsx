  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center p-8">
      <div className="text-center max-w-md space-y-5">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-600 to-purple-800 flex items-center justify-center mx-auto text-3xl shadow-lg shadow-purple-500/20">⚙️</div>
        <h2 className="text-2xl font-black text-white">TerrellOS Settings</h2>
        <p className="text-gray-400 text-sm leading-relaxed">Configure environment variables, API keys, and platform preferences.</p>
